...
<title>Login Cliente</title><link rel="stylesheet" href="<?= url('/css/style.css') ?>">
...
<div class="auth-wrap">
  <form class="auth-card" method="post" data-validate>
    ...
    <div class="links"><a href="<?= url('/recuperar.php') ?>" style="color:#fff">Esqueceu a senha?</a></div>
    <button class="btn btn-block">Entrar</button>
    <div class="links"><a href="<?= url('/cadastro.php') ?>" style="color:#fff">Criar conta</a></div>
  </form>
</div>
</body></html>
